...
namespace qw 
{
  ...
  template<typename TCore, typename TBase> class vScalar {
  ...
  private:
    ...
    vScalar& operator=(const TCore& x) { core = x; return *this; };
  ...
  public:
    ...
    vScalar& operator=(const vScalar& x) { core = x.core; return *this; };
    ...
    vScalar& operator++()    { core = core + 1.f; return *this; };
    vScalar  operator++(int) { 
      vScalar ret(*this + 1.f); core = core + 1.f; return ret; 
    };
    vScalar& operator--()    { core = core - 1.f; return *this; };
    vScalar  operator--(int) { 
      vScalar ret(*this - 1.f); core = core - 1.f; return ret; 
